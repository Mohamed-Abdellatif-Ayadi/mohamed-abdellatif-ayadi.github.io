...
const Projects = () => {
  ...
  const projects: Project[] = [
    {
      ...
      imageUrl: "/images/test-placeholder.svg",
  ...
  return (
    <>
      <Helmet>
        <title>Projects - Mohamed Abdellatif Ayadi</title>
        <meta name="description" content="Explore the projects developed by Mohamed Abdellatif Ayadi, including web applications, data analysis and more." />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg opacity-90 mb-6">
              A showcase of my technical work and projects
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          ...
          {filteredProjects.length === 0 && (
            <div className="text-center py-12">
              <p className="text-slate-600">No projects found in this category. Check back later!</p>
            </div>
          )}
        </div>
      </div>
