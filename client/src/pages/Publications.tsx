...
const Publications = () => {
  ...
  const [publications] = useState<Publication[]>([
    {
      ...
      tags: ["ROS", "YOLOv5", "Python", "Navigation", "Teamwork & Collaboration", "Mapping & Localization", "Path Planning", "Embedded Systems", "Object Detection"],
  ...
  return (
    <>
      <Helmet>
        <title>{publicationTitles[language as keyof typeof publicationTitles] || publicationTitles.en} - Mohamed Abdellatif Ayadi</title>
        <meta name="description" content={publicationSubtitles[language as keyof typeof publicationSubtitles] || publicationSubtitles.en} />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              {publicationTitles[language as keyof typeof publicationTitles] || publicationTitles.en}
            </h1>
            <p className="text-lg opacity-90">
              {publicationSubtitles[language as keyof typeof publicationSubtitles] || publicationSubtitles.en}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            {publications.map((publication) => (
              <Card key={publication.id} className="mb-8 p-8 bg-white shadow-sm hover:shadow-md transition-shadow">
                <div className="space-y-6">
                  ...
                  <div className="space-y-2 text-sm text-slate-600">
                    <p>
                      <span className="font-medium">
                        {buttonLabels.journal[language as keyof typeof buttonLabels.journal] || buttonLabels.journal.en}
                      </span>{" "}
                      <span className="italic">{publication.journal}</span>
                    </p>
                    <p>
                      <span className="font-medium">
                        {buttonLabels.date[language as keyof typeof buttonLabels.date] || buttonLabels.date.en}
                      </span>{" "}
                      {publication.date}
                    </p>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-3 pt-4">
                    {publication.pdfUrl && (
                      ...
                      >
                        <a href={publication.pdfUrl} target="_blank" rel="noopener noreferrer">
                          ...
                          {buttonLabels.readPublication[language as keyof typeof buttonLabels.readPublication] || buttonLabels.readPublication.en}
                        </a>
                      </Button>
                    )}
                    ...
                    {publication.presentationUrl && (
                      ...
                      >
                        <a href={publication.presentationUrl} target="_blank" rel="noopener noreferrer">
                          ...
                          {buttonLabels.viewPresentation[language as keyof typeof buttonLabels.viewPresentation] || buttonLabels.viewPresentation.en}
                        </a>
                      </Button>
                    )}
                    ...
                    {publication.demoUrl && (
                      ...
                      >
                        <a href={publication.demoUrl} target="_blank" rel="noopener noreferrer">
                          <Play className="w-4 h-4 mr-2" />
                          {buttonLabels.viewDemo[language as keyof typeof buttonLabels.viewDemo] || buttonLabels.viewDemo.en}
                        </a>
                      </Button>
                    )}
                  </div>
      ...
      <section className="py-16 bg-primary-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="max-w-xl mx-auto mb-8 opacity-90">
            I'm always open to discussing research opportunities, collaboration on innovative projects, and sharing knowledge in robotics and AI.
          </p>
