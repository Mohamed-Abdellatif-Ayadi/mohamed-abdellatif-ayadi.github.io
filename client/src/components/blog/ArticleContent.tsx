...
const ArticleContent = ({ article }: ArticleContentProps) => {
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-8">
      ...
      {/* Reading Time & Date */}
      <div className="flex items-center text-sm text-white font-medium mb-4">
      ...
      <div className="flex items-center mb-8 pb-6 border-b border-slate-200">
        ...
        />
        <div>
          <div className="text-sm text-white font-medium mb-1">{t('blog.author')}</div>
      ...
      <div className="mt-12 pt-8 border-t border-slate-200">
        <h3 className="text-lg font-bold mb-4 text-white">{t('blog.shareArticle')}:</h3>
