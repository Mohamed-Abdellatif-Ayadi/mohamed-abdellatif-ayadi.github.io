      ...
      <div className="flex items-center mb-8 pb-6 border-b border-slate-200">
        ...
        <div>
          ...
          <div className="flex mt-2 space-x-3">
            ...
            <a href="https://github.com/Mayedi007" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-indigo-600">
              <FaGithub size={18} />
            </a>
            <a href="mailto:mohamed.ayadi.data@gmail.com" className="text-slate-400 hover:text-indigo-600">
              <FaEnvelope size={18} />
            </a>
          </div>
        </div>
