...
export class MemStorage implements IStorage {
  ...
  constructor() {
    ...
    const frenchCV = {
      ...
      summary: "Je suis Mohamed Abdellatif Ayadi, étudiant en 4ème semestre de B.Sc. Informatique à l'Université Technique de Dortmund. Je travaille actuellement comme étudiant salarié dans le domaine de la vente en tant que conseiller commercial. Avec une grande passion pour la vente, la programmation, l'innovation et l'industrie technologique, je suis curieux, déterminé et ambitieux. Je suis toujours à la recherche d'opportunités pour apprendre et me développer dans les domaines du développement logiciel ou du conseil en informatique. Mon objectif est de travailler sur des projets qui font la différence et de faire partie des innovations de demain.",
      contact: {
        email: "mohamed.ayadi.data@gmail.com",
        phone: "0152 5230 1739",
